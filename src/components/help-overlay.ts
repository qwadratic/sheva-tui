...
const HELP_LINES = [
	...
	"",
	`${bold("Navigation")}`,
	`  ${cyan("Tab")}          Switch focus between peers and chat`,
	`  ${cyan("↑ / ↓")}        Navigate peer list`,
	`  ${cyan("Enter")}        Open chat with selected peer / send message`,
	...
	`  ${cyan("a")}            Approve/deny first pending connection`,
